...
//              LEDs to flash to evacuate.
//
//              A cool thing about the interrupt that is caused by clicking the
//              button is that even though the "main" action is pressing the
//              button down which completes the circuit to the INTERRUPT_PIN
//              making it HIGH, the final change is after I let go because I 
//              am clicking not pressing down is a HIGH --> LOW. This is why
//              my mode parameter in attachInterrupt() is FALLING.
//
// ----------------------------------------------------------------------------
